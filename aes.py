...
sbox, inv_sbox = chunks(consts[0:2**8], 16), chunks(consts[2**8:2**9], 16)
mc_mtx, inv_mc_mtx = chunks(consts[2**9:2**9+2**4], 4), chunks(consts[2**9+2**4:2**9+2**5], 4)
rcon = [x << 24 for x in consts[2**9+2**5:]]
